...
class CapesController(private val equipementsDAO: EquipementsDAO) {
    ...
    fun filterByLevel(@RequestParam page: Int, @RequestParam level: Int): List<Equipement> {
    ...
    companion object {
        const val dir = "src/main/resources/capes.json"
    }
}